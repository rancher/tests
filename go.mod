...
replace (
	...
	github.com/rancher/tfp-automation => github.com/rancher/tfp-automation v0.0.0-20260728145805-33b5293c866d
...
require (
	...
	github.com/rancher/tfp-automation v0.0.0-20260727164403-ff67ffe8acbe
)
