...
replace (
	...
	github.com/rancher/rancher/pkg/apis => github.com/rancher/rancher/pkg/apis v0.0.0-20251107181200-efcbd5d43f4e
...
require (
	...
	github.com/rancher/tfp-automation v0.0.0-20251105191726-60ebaf75cb5e
