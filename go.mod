...
replace (
	...
	github.com/rancher/rancher/pkg/apis => github.com/rancher/rancher/pkg/apis v0.0.0-20250806132112-f14217761e1b
...
require (
	...
	github.com/rancher/tests/actions v0.0.0-20250806151726-9e664e076497
