...
type TestProjectSchema struct {
	Project    string            `json:"project,omitempty" yaml:"project,omitempty"`
	SchemaFile string            `json:"schemaFile,omitempty" yaml:"schemaFile,omitempty"`
	Suites     []TestSuiteSchema `json:"suites,omitempty" yaml:"suites,omitempty"`
}
...
func createSuitePath(client *Service, suiteName, project string) (int64, error) {
	...
	for _, suite := range suites {
		testSuite, err := client.GetTestSuite(project, suite)
		if testSuite != nil {
