...
func importK3SIPv6Setup(t *testing.T) importK3SIPv6Test {
	var k importK3SIPv6Test
...
func TestImportK3SIPv6(t *testing.T) {
	t.Parallel()
	k := importK3SIPv6Setup(t)
	...
	tests := []struct {
		...
		{"K3S_IPv6_Imported|etcd_cp_worker", k.standardUserClient, nodeRolesAll},
		{"K3S_IPv6_Imported|etcd_cp|worker", k.standardUserClient, nodeRolesShared},
		{"K3S_IPv6_Imported|etcd|cp|worker", k.standardUserClient, nodeRolesDedicated},
		{"K3S_IPv6_Imported|3_etcd|2_cp|3_worker", k.standardUserClient, nodeRolesStandard},
	}
