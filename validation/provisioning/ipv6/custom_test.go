...
func TestCustomIPv6(t *testing.T) {
	...
	tests := []struct {
		...
		{"RKE2_IPv6_Custom|etcd_cp_worker", r.standardUserClient, nodeRolesAll, false},
		{"RKE2_IPv6_Custom|etcd_cp|worker", r.standardUserClient, nodeRolesShared, false},
		{"RKE2_IPv6_Custom|etcd|cp|worker", r.standardUserClient, nodeRolesDedicated, false},
		{"RKE2_IPv6_Custom|3_etcd|2_cp|3_worker", r.standardUserClient, nodeRolesStandard, false},
	}
