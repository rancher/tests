...
func TestECR(t *testing.T) {
	...
	tests := []struct {
		...
		{"ECR_RKE2", r.standardUserClient, defaults.RKE2, nodeRolesDedicated, r.terraformConfig.StandaloneRegistry.ECRURI},
		{"ECR_K3S", r.standardUserClient, defaults.K3S, nodeRolesAll, r.terraformConfig.StandaloneRegistry.ECRURI},
	}
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			clusterConfig.Registries.RKE2Password = r.terraformConfig.StandaloneRegistry.ECRPassword
			clusterConfig.Registries.RKE2Username = r.terraformConfig.StandaloneRegistry.ECRUsername
