...
func TestCustom(t *testing.T) {
	...
	tests := []struct {
		...
		{"K3K_Custom|etcd_cp_worker", k.standardUserClient, nodeRolesAll},
		{"K3K_Custom|etcd_cp|worker", k.standardUserClient, nodeRolesShared},
		{"K3K_Custom|etcd|cp|worker", k.standardUserClient, nodeRolesDedicated},
		{"K3K_Custom|3_etcd|2_cp|3_worker", k.standardUserClient, nodeRolesStandard},
	}
