...
func TestNodeDriver(t *testing.T) {
	...
	tests := []struct {
		...
		{"K3K_Node_Driver|etcd_cp_worker", nodeRolesAll, k.standardUserClient},
		{"K3K_Node_Driver|etcd_cp|worker", nodeRolesShared, k.standardUserClient},
		{"K3K_Node_Driver|etcd|cp|worker", nodeRolesDedicated, k.standardUserClient},
		{"K3K_Node_Driver|3_etcd|2_cp|3_worker", nodeRolesStandard, k.standardUserClient},
	}
