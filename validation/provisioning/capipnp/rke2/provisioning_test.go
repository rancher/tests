...
func TestProvisioning(t *testing.T) {
	...
	tests := []struct {
		...
		{"CAPI_RKE2|etcd_cp_worker", nodeRolesAll},
		{"CAPI_RKE2|etcd_cp|worker", nodeRolesShared},
		{"CAPI_RKE2|etcd|cp|worker", nodeRolesDedicated},
		{"CAPI_RKE2|3_etcd|2_cp|3_worker", nodeRolesStandard},
	}
