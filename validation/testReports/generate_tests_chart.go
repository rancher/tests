...
const (
	headerPath   = "validation/testReports/assets/workflow_header.html"
	templatePath = "validation/testReports/assets/template.html"
...
func main() {
	...
	cssBytes, err := os.ReadFile("validation/testReports/assets/style.css")
	if err != nil {
		logrus.Fatal(err)
	}

	jsBytes, err := os.ReadFile("validation/testReports/assets/toggle.js")
	if err != nil {
		logrus.Fatal(err)
	}

	pngBytes, err := os.ReadFile("validation/testReports/assets/rancher.png")
	if err != nil {
		logrus.Fatal(err)
	}
