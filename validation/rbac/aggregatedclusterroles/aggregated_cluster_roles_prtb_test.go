...
func (acrp *AggregatedClusterRolesPrtbTestSuite) TestPrtbInheritanceWithProjectMgmtResources() {
	...
	err = rbac.VerifyBindingsForPrtb(acrp.client, rbac.LocalCluster, &prtbs[0], []*corev1.Namespace{prtbNamespace}, 1, 0)
	require.NoError(acrp.T(), err)
...
func (acrp *AggregatedClusterRolesPrtbTestSuite) TestPrtbInheritanceWithRegularResources() {
	...
	err = rbac.VerifyBindingsForPrtb(acrp.client, rbac.LocalCluster, &prtbs[0], []*corev1.Namespace{prtbNamespace}, 0, 0)
	require.NoError(acrp.T(), err)
...
func (acrp *AggregatedClusterRolesPrtbTestSuite) TestPrtbInheritanceWithTwoPrtbs() {
	...
	err = rbac.VerifyBindingsForPrtb(acrp.client, rbac.LocalCluster, &prtbs[0], []*corev1.Namespace{prtb1Namespace}, 1, 0)
	require.NoError(acrp.T(), err)
	...
	err = rbac.VerifyBindingsForPrtb(acrp.client, rbac.LocalCluster, &prtbs[1], []*corev1.Namespace{prtb2Namespace}, 1, 0)
	require.NoError(acrp.T(), err)
...
func (acrp *AggregatedClusterRolesPrtbTestSuite) TestPrtbVerifyCrossClusterAndProjectAccessRestriction() {
	...
	createdProject, createdNamespaces, createdUser, _, _, createdSecret, err := acrCreateTestResourcesForPrtb(acrp.client, acrp.cluster)
	require.NoError(acrp.T(), err)

	createdProject2, err := projects.CreateProjectUsingWrangler(acrp.client, acrp.cluster.ID)
	require.NoError(acrp.T(), err, "Failed to create project")
	createdNamespace2, err := projects.CreateNamespaceUsingWrangler(acrp.client, acrp.cluster.ID, createdProject2.Name, nil)
	require.NoError(nil, err, "Failed to create namespace")
	secretData := map[string][]byte{
		"hello": []byte("world"),
	}
	...
	require.NoError(nil, err, "Failed to create secret in namespace %s", createdNamespace2.Name)

	createdProject3, err := projects.CreateProjectUsingWrangler(acrp.client, rbac.LocalCluster)
	require.NoError(acrp.T(), err, "Failed to create project")
	...
	createdPrtb2, err := rbac.CreateProjectRoleTemplateBinding(acrp.client, createdUser, createdProject2, rbac.SecretsView.String())
	require.NoError(acrp.T(), err, "Failed to assign role to user")
	...
	createdPrtb3, err := rbac.CreateProjectRoleTemplateBinding(acrp.client, createdUser, createdProject3, rbac.SecretsView.String())
	require.NoError(acrp.T(), err, "Failed to assign role to user")
	...
	require.NoError(acrp.T(), rbac.VerifyUserPermission(acrp.client, acrp.cluster.ID, createdUser, "patch", "projectroletemplatebindings", createdPrtb.Namespace, createdPrtb.Name, true, true))
	require.NoError(acrp.T(), rbac.VerifyUserPermission(acrp.client, acrp.cluster.ID, createdUser, "delete", "projectroletemplatebindings", createdPrtb.Namespace, createdPrtb.Name, false, true))
	require.NoError(acrp.T(), rbac.VerifyUserPermission(acrp.client, acrp.cluster.ID, createdUser, "get", "secrets", namespaceName, createdSecret[0].Name, false, false))

	require.NoError(acrp.T(), rbac.VerifyUserPermission(acrp.client, acrp.cluster.ID, createdUser, "get", "projectroletemplatebindings", createdPrtb2.Namespace, createdPrtb2.Name, false, true))
	require.NoError(acrp.T(), rbac.VerifyUserPermission(acrp.client, acrp.cluster.ID, createdUser, "list", "projectroletemplatebindings", createdPrtb2.Namespace, "", false, true))
	require.NoError(acrp.T(), rbac.VerifyUserPermission(acrp.client, acrp.cluster.ID, createdUser, "update", "projectroletemplatebindings", createdPrtb2.Namespace, createdPrtb2.Name, false, true))
	require.NoError(acrp.T(), rbac.VerifyUserPermission(acrp.client, acrp.cluster.ID, createdUser, "patch", "projectroletemplatebindings", createdPrtb2.Namespace, createdPrtb2.Name, false, true))
	require.NoError(acrp.T(), rbac.VerifyUserPermission(acrp.client, acrp.cluster.ID, createdUser, "get", "secrets", createdNamespace2.Name, createdSecret2.Name, true, false))

	require.NoError(acrp.T(), rbac.VerifyUserPermission(acrp.client, rbac.LocalCluster, createdUser, "get", "projectroletemplatebindings", createdPrtb3.Namespace, createdPrtb3.Name, false, true))
	require.NoError(acrp.T(), rbac.VerifyUserPermission(acrp.client, rbac.LocalCluster, createdUser, "list", "projectroletemplatebindings", createdPrtb3.Namespace, "", false, true))
	require.NoError(acrp.T(), rbac.VerifyUserPermission(acrp.client, rbac.LocalCluster, createdUser, "update", "projectroletemplatebindings", createdPrtb3.Namespace, createdPrtb3.Name, false, true))
	require.NoError(acrp.T(), rbac.VerifyUserPermission(acrp.client, rbac.LocalCluster, createdUser, "patch", "projectroletemplatebindings", createdPrtb3.Namespace, createdPrtb3.Name, false, true))
}
