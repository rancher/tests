...
type LonghornCustomTestSuite struct {
	suite.Suite
...
func (l *LonghornCustomTestSuite) TearDownSuite() {
	l.session.Cleanup()
}

func (l *LonghornCustomTestSuite) SetupSuite() {
...
func TestLonghornCustomChartInstallTestSuite(t *testing.T) {
	suite.Run(t, new(LonghornCustomTestSuite))
}
