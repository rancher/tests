...
func (pu *UsersTestSuite) SetupSuite() {
...
func (pu *UsersTestSuite) TearDownSuite() {
	pu.session.Cleanup()
}

func (pu *UsersTestSuite) TestCreateUserAsAdmin() {
...
func (pu *UsersTestSuite) TestCreateUserWithManageUsersRole() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestStandardUserCannotCreateUser() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestDuplicateUsernamesNotAllowed() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestCreatingPasswordSecretBeforeUserIsBlocked() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestUpdateUserAsAdmin() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestUpdateUserWithManageUsersRole() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestStandardUserCannotUpdateUser() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestCreateUserWithoutUsernameAndUpdate() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestUsernameIsImmutable() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestCannotUpdateUsernameToExistingAdmin() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestAdminCanGetAndListUsers() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestManageUsersCanGetAndListUsers() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestStandardUserCanGetSelf() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestStandardUserCannotListAllUsers() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestAdminCanDeleteUser() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestAdminCannotDeleteSelf() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestManageUsersCanDeleteUser() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestManageUsersCannotDeleteSelf() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestStandardUserCannotDeleteOtherUsers() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestUserDeletionRemovesBackingSecret() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestDeletingBackingSecretBlocksUserAccess() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestDeactivateAndReactivateUserAsAdmin() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestAdminCannotDeactivateSelf() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestManageUsersCannotDeactivateSelf() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestDeactivateAndReactivateUserAsManageUsers() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestStandardUserCannotDeactivateOtherUser() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestAdminChangeUserPassword() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestAdminChangeUserPasswordWithoutCurrentPassword() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestChangeUserPasswordWithInvalidUserID() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestPasswordCreateWithShortPassword() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
	...
	passwordLength, err := userapi.GetPasswordMinLength(pu.client)
...
func (pu *UsersTestSuite) TestChangePasswordWithShortPassword() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestPasswordCannotBeSameAsUsernameOnCreate() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestPasswordCannotBeSameAsUsernameOnUpdate() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestDeprecatedPasswordFieldIgnored() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestSelfUserAsAdmin() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestSelfUserAsStandardUser() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestGroupMembershipRefreshSingleUser() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
...
func (pu *UsersTestSuite) TestGroupMembershipRefreshAllUsers() {
	subSession := pu.session.NewSession()
	defer subSession.Cleanup()
