...
func (kc *ExtKubeconfigTestSuite) SetupSuite() {
	...
	aceClusterObject1, aceClusterConfig1, err := provisioning.CreateDownstreamClusterWithACEOption(kc.client, true)
	require.NoError(kc.T(), err)
	...
	aceClusterObject2, aceClusterConfig2, err := provisioning.CreateDownstreamClusterWithACEOption(kc.client, true)
	require.NoError(kc.T(), err)
	...
	clusterObject2, clusterConfig2, err := provisioning.CreateDownstreamClusterWithACEOption(kc.client, false)
	require.NoError(kc.T(), err)
