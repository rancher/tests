...
func main() {
	...
	case terraformConfig.AWSConfig.EnablePrimaryIPv6:
		client, err = setupRancherIPv6(t, rancherConfig, terraformConfig, terratestConfig)
		if err != nil {
...
func setupRancherIPv6(t *testing.T, rancherConfig *rancher.Config, terraformConfig *tfpConfig.TerraformConfig,
	terratestConfig *tfpConfig.TerratestConfig) (*rancher.Client, error) {
