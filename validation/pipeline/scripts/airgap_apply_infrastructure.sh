...
cp /root/infrastructure-outputs.json /root/infrastructure-outputs.json
echo 'Infrastructure outputs copied to shared volume location: /root/infrastructure-outputs.json'
