...
replace (
	...
	github.com/rancher/tfp-automation => github.com/floatingman/tfp-automation v0.0.0-20250407152850-eb546a9d9de6
...
require (
	...
	github.com/rancher/tests v0.0.0-20250529185859-81f8c6986126
